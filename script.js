...
*/
function translator(str) {
  var hangulArray = str.split('');
  var retStr = "";

  for ( var i=0, len=hangulArray.length; i<len; i++ ) {
    var oneHangul = hangulArray[i];
    var d = Hangul.disassemble(oneHangul);
